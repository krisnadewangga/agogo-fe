        ...
        production: [
           ...
           Object.assign({}, this.state.production[index], {penjualan_toko: pesan.count_order},
                                                           ...
                                                           {sisa_stock: 
                                                            ...
                                                            - parseInt(pesan.production.penjualan_toko )
                                                            - parseInt(pesan.production.penjualan_pemesanan)
...
addSelectedTransaction(id, current, idx) {
 ...
 // detail tampilan refund
  ...
  sumGrandTotalAmount() {
    ...
    let grandPajak = parseInt(sumTotalAmount * this.state.persenTax /100)
      ...
      this.state.activeInputRefund === "refundCode5"){
        ...
        if(qty1 !== 0){
          ...
          this.setState({
            production : [
               ...this.state.production.slice(0,index),
               Object.assign({}, this.state.production[index], {produksi1: parseInt(this.state.production[index].produksi1 || 0 ) + parseInt(qty1 || 0)}, {produksi2: this.state.production[index].produksi2 || 0}, {produksi3: this.state.production[index].produksi3 || 0},
               ...
               {sisa_stock: parseInt(this.state.production[index].stock_awal || 0) 
                + parseInt(this.state.production[index].produksi1 || 0 ) + parseInt(qty1 || 0)
               ...
               ...this.state.production.slice(index+1)
                ...
                this.setState({
                  production: [
                     ...this.state.production.slice(0,index),
                     Object.assign({}, this.state.production[index], {ket_rusak: parseInt(this.state.production[index].ket_rusak || 0 ) + parseInt(qty4 || 0)}, 
                     {total_lain: parseInt(this.state.production[index].ket_rusak || 0 ) + parseInt(qty4 || 0) + parseInt(this.state.production[index].ket_lain || 0)},
                     {sisa_stock: parseInt(this.state.production[index].stock_awal || 0) 
                ...
                this.setState({
                  production: [
                     ...this.state.production.slice(0,index),
                     Object.assign({}, this.state.production[index], {ket_lain: parseInt(this.state.production[index].ket_lain || 0 ) + parseInt(qty5 || 0)}, {total_lain: parseInt(this.state.production[index].ket_lain || 0 ) + parseInt(qty5 || 0) + parseInt(this.state.production[index].ket_rusak || 0)},
                     {sisa_stock: parseInt(this.state.production[index].stock_awal || 0) 
                      + parseInt(this.state.production[index].produksi1 || 0)
                      + parseInt(this.state.production[index].produksi2 || 0)
                      + parseInt(this.state.production[index].produksi3 || 0) 
