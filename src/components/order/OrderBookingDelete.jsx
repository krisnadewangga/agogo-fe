  ...
  return (
    <div>
      <Container className="reservation">
        <NavLink onClick={() => props.cartStore.toggleOrderBookingDeleteShow()} className="sidebar-header-nav" style={{color: "white"}}><i className="fas fa-arrow-left mr-2" style={{color: "white"}}></i>Delete Pemesanan</NavLink>
