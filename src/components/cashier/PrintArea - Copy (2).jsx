...
<div>
  ...
  <div id="kasirBayar" style={{fontFamily: 'Arial, Helvetica, sans-serif'}}>
    ...
    <div id="pesananRefund">
      ...
      {/* KASIR BAYAR*/}
  <div id="kasirBayarTax" style={{fontFamily: 'Arial, Helvetica, sans-serif'}}>
    {/* {headContent()} */}
    --------------------------------------------
      <table>
        <tr>
        ...
        <table>
          ...
          <table>
               ...
               <td style={{fontFamily: 'Arial, Helvetica, sans-serif'}}align="center"> : &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; </td>
               <td style={{fontFamily: 'Arial, Helvetica, sans-serif', float:'right'}}align="right"><NumberFormat prefix={'Rp '} value={props.cartStore.state.totalTax} displayType={'text'} thousandSeparator={'.'} decimalSeparator={','} /></td>
              </tr>
